          ...
          <div className="flex items-center gap-2">
            ...
            {onToggleSave && (
              <button
                ...
                className="ml-auto inline-flex h-7 w-7 items-center justify-center rounded-full border border-parchment-300 text-ink-secondary transition-colors hover:border-accent hover:text-ink disabled:opacity-60 dark:border-[#2a313d] dark:text-[#adb7c7] dark:hover:text-[#eef1f8]"
      ...
      <div className="flex items-center gap-2 border-b border-parchment-200 px-4 py-2.5 dark:border-[#202631]">
        ...
        {onToggleSave && (
          <button
            ...
            onClick={onToggleSave}
            disabled={isSaveDisabled}
            className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-parchment-300 text-ink-secondary transition-colors hover:border-accent hover:text-ink disabled:opacity-60 dark:border-[#2a313d] dark:text-[#adb7c7] dark:hover:text-[#eef1f8]"
            aria-label={isSaved ? "Remove from saved" : "Save article"}
          >
