      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {!isAuthLoading && user && (
            <>
              <button
                ...
                className="hidden items-center gap-2 rounded-full border border-parchment-300 bg-white pl-1.5 pr-3 py-1.5 text-xs font-semibold uppercase tracking-wide text-ink-secondary transition-colors hover:border-accent hover:text-ink dark:border-[#2a313d] dark:bg-[#151922] dark:text-[#adb7c7] dark:hover:text-[#eef1f8] sm:inline-flex"
              >
                <span className="flex h-6 w-6 items-center justify-center overflow-hidden rounded-full border border-parchment-300 bg-parchment text-[10px] font-bold text-ink-secondary dark:border-[#2a313d] dark:bg-[#111317] dark:text-[#adb7c7]">
                  {user.photoURL ? (
          ...
          {!isAuthLoading && (
            ...
            >
              {user ? (
                <span className="flex h-4 w-4 items-center justify-center overflow-hidden rounded-full text-[9px] font-bold leading-none">
                  {user.photoURL ? (
                    <img src={user.photoURL} alt="Profile" className="h-full w-full object-cover" />
                  ) : (
                    avatarInitial
