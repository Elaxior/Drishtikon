    ...
    <div className="group rounded-lg border border-parchment-200 bg-parchment/60 transition-all duration-200 hover:border-parchment-300 hover:shadow-sm dark:border-[#2e2923] dark:bg-[#151310]/60 dark:hover:border-[#3a342c]">
      ...
      <div className="p-3">
        ...
        <div className="mb-1.5 flex items-center gap-1.5">
          ...
          <span className="truncate text-[11px] text-ink-muted dark:text-[#8a8279]">
        ...
        {article.link ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="line-clamp-3 text-sm font-medium leading-snug text-ink transition-colors hover:text-ink-secondary dark:text-[#f5f0e8] dark:hover:text-[#b8b0a4]"
          >
            {article.title ?? "Untitled"}
          </a>
        ) : (
          <p className="line-clamp-3 text-sm font-medium leading-snug text-ink dark:text-[#f5f0e8]">
            {article.title ?? "Untitled"}
          </p>
        )}
      </div>
    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-center gap-1.5">
        {article.link ? (
          ...
          <p className="line-clamp-2 text-sm font-medium leading-snug text-ink dark:text-[#f5f0e8]">
