      ...
      <main className="px-4 pb-14 pt-6">
        <section className="mx-auto max-w-7xl space-y-10">
          <header className="surface-panel relative animate-fade-in-scale overflow-hidden rounded-[2rem] px-5 py-8 sm:px-8 md:px-10 md:py-10">
            ...
            <div className="mt-6 rounded-2xl border border-parchment-300 bg-white/75 px-4 py-3 dark:border-[#2a313d] dark:bg-[#111317]/65">
          ...
          <section className="rounded-3xl border border-parchment-300 bg-white/80 p-4 shadow-sm dark:border-[#2a313d] dark:bg-[#111317]/75">
