      ...
      <section className="mx-auto max-w-7xl space-y-6">
        <header className="surface-panel rounded-[2rem] px-6 py-8 sm:px-8">
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="hidden h-16 w-16 items-center justify-center rounded-2xl border border-parchment-300 bg-white/80 text-ink-secondary shadow-sm dark:border-[#2a313d] dark:bg-[#151922]/80 dark:text-[#adb7c7] sm:flex">
