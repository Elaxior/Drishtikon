...
const SOCIAL_WINDOW_POSTS = [
  {
    ...
    replies: "2.7K",
    reposts: "5.4K",
    topContradiction: "Critics say the move could increase fiscal pressure before energy costs stabilize.",
  ...
  },
  {
    ...
    replies: "1.2K",
    reposts: "2.3K",
    topContradiction: "Supporters argue no formal subpoena timeline has been confirmed yet by committee chairs.",
  ...
  },
  {
    ...
    replies: "943",
    reposts: "1.1K",
    topContradiction: "Small-business groups dispute household-level gains, citing rent and utility pressure.",
  ...
  },
  {
    ...
    replies: "3.1K",
    reposts: "4.2K",
    topContradiction: "Opposition voices claim symbolic rhetoric is replacing concrete policy detail.",
  ...
  },
  {
    ...
    replies: "2.4K",
    reposts: "3.8K",
    topContradiction: "Free-speech advocates question consistency with prior entry decisions for comparable cases.",
  ...
  },
  {
    ...
    replies: "4.7K",
    reposts: "6.3K",
    topContradiction: "Security analysts say deterrence still requires calibrated military readiness in parallel.",
  ...
  },
  {
    ...
    replies: "1.6K",
    reposts: "2.2K",
    topContradiction: "Government sources reject the claim and cite operational secrecy and technical variables.",
  ...
  },
  {
    ...
    replies: "2.2K",
    reposts: "3.9K",
    topContradiction: "Policy experts say escalation language may be performative and not tied to immediate orders.",
  ...
  },
  {
    ...
    replies: "2.1K",
    reposts: "1.9K",
    topContradiction: "Education boards argue exam delays could create larger inequities for rural applicants.",
                    ...
                    {SOCIAL_WINDOW_POSTS.map((post, index) => (
                      ...
                      >
                        ...
                        <div className="mt-3 rounded-lg border border-red-500/25 bg-red-500/10 px-3 py-2">
                          ...
                          <p className="mt-1 line-clamp-2 text-xs leading-relaxed text-red-800 dark:text-red-200">
                            {post.topContradiction}
                          </p>
                        </div>
