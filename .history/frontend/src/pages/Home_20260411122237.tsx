      ...
      <main className="px-4 pb-14 pt-6">
        <section className="mx-auto max-w-7xl space-y-10">
          <header className="surface-panel relative animate-fade-in-scale overflow-hidden rounded-[2rem] px-5 py-8 sm:px-8 md:px-10 md:py-10">
            <span
              className={`absolute right-5 top-5 inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide ${
                isBackendConnected
                  ? "border-emerald-300/70 text-emerald-600 dark:border-emerald-700/60 dark:text-emerald-400"
                  : "border-amber-300/70 text-amber-600 dark:border-amber-700/60 dark:text-amber-300"
              }`}
            >
              <span
            ...
            <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
              ...
              <div className="space-y-4">
                <div className="rounded-3xl border border-parchment-300 bg-white/80 p-4 shadow-sm dark:border-[#2a313d] dark:bg-[#111317]/75">
                  ...
                  <div className="relative h-[122px] overflow-hidden rounded-2xl border border-parchment-300 bg-parchment-dark/50 dark:border-[#2a313d] dark:bg-[#151922]/70">
                    {SOCIAL_WINDOW_POSTS.map((post, index) => (
                      <div
                        key={post.author}
                        className="absolute inset-0 p-3 transition-transform duration-700 ease-out"
                      ...
                      >
                        ...
                        <p className="line-clamp-3 text-sm leading-relaxed text-ink blur-[1.3px] dark:text-[#d7dfeb]">
                          {post.text}
                        </p>

                        <div className="mt-3 flex items-center gap-3 text-[11px] text-ink-muted dark:text-[#8892a3]">
