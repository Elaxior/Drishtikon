...
const SECTION_CONFIG: Array<{
  ...
  {
    key: "general",
    title: "General Trending",
    subtitle: "Top headlines making waves globally",
    icon: Globe,
  },
  {
    key: "war",
    title: "War Updates",
    subtitle: "Active conflict coverage from multiple sources",
    icon: Swords,
  },
  {
    key: "geopolitics",
    title: "Geopolitics",
    subtitle: "Strategic power dynamics and international relations",
    icon: Landmark,
  },
];
      ...
      <section className="mx-auto w-full max-w-7xl space-y-10">
        ...
        <header className="space-y-2">
          ...
          <p className="max-w-xl text-base text-ink-secondary dark:text-[#b8b0a4]">
            Major developments at a glance across global news flows. Every story
            shows bias distribution so you can read with context.
          </p>
        </header>
