              ...
              <div className="flex h-full flex-col">
                ...
                <div className="flex min-h-[240px] flex-1 flex-col rounded-3xl border border-parchment-300 bg-white/80 p-4 shadow-sm dark:border-[#2a313d] dark:bg-[#111317]/75 lg:min-h-0">
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <p className="text-[10px] uppercase tracking-wide text-ink-muted dark:text-[#8892a3]">
                      live post stream
                    </p>
                  </div>
                  ...
                  <Marquee
                    pauseOnHover
                    repeat={5}
                    className="mt-1 flex-1 rounded-2xl border border-parchment-300 bg-parchment-dark/50 [--duration:34s] [--gap:0.75rem] dark:border-[#2a313d] dark:bg-[#151922]/70"
                    ariaLabel="Social media post slideshow"
                  >
                    {SOCIAL_WINDOW_POSTS.map((post) => (
                      <article
                        key={post.username}
                        className="flex w-[248px] shrink-0 flex-col rounded-xl border border-parchment-300 bg-white/90 p-3 shadow-sm dark:border-[#2a313d] dark:bg-[#111317]/85"
                      >
                        <div className="mb-2 flex items-center gap-2">
                          ...
                          <div className="min-w-0">
                            ...
                            <p className="truncate text-[11px] text-ink-muted dark:text-[#8892a3]">
                              {post.username}
                            </p>
                          </div>
                          <span className="ml-auto text-[11px] text-ink-muted dark:text-[#8892a3]">{post.country}</span>
                        </div>

                        <p className="line-clamp-4 text-sm leading-relaxed text-ink blur-[1.2px] dark:text-[#d7dfeb]">
                          {post.body}
                        </p>

                        <div className="mt-auto pt-3 text-[11px] text-ink-muted dark:text-[#8892a3]">
